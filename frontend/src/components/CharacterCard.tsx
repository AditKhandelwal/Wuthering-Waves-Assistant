...
export function CharacterCard({ character, onSelect }: CharacterCardProps) {
  return (
    ...
    >
      <span
        className={`h-20 w-20 overflow-hidden rounded-full ring-2 ${ELEMENT_RING_CLASS[character.element]} ring-offset-2 ring-offset-bg transition group-hover:ring-gold group-focus-visible:ring-gold`}
      >
        <img
